...
*/	
	...
	protected class getImage extends AsyncTask<String, Integer, Bitmap> {
		...
		protected void onPostExecute(Bitmap imagePic) {
			...
			Log.i("Google Image Search", "Progress count = "
					+ progressCount);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//_search_query_auto = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView1);		
		...
		/*_search_query_auto.setKeyListener(new KeyListener() {
			...
			public boolean onKeyUp(View arg0, Editable arg1, int arg2, KeyEvent arg3) {
				...
				Log.i(LOG_TAG, "Entered on key up function");
				Log.i(LOG_TAG, "Entered on key ="+_search_query_auto.getText().toString());
				autocomplete(_search_query_auto.getText().toString());
				return true;
			}
		...
		_search_query_auto.setAdapter(new PlacesAutoCompleteAdapter(this, R.layout.autolist));
*/		
		...
		_search_button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				_thumbNailImages.removeAll(_thumbNailImages);
				Log.i("Google Image Search", "ThumbnailImagesArraySizeAfterClick = "
						+ _thumbNailImages.size());
